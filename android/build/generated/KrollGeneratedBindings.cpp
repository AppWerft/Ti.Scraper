...
namespace titanium {
	namespace bindings {
		...
		BindEntry* ScraperBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"de.appwerft.scraper.ScraperModule", ::de::appwerft::scraper::ScraperModule::bindProxy, ::de::appwerft::scraper::ScraperModule::dispose}
			};
